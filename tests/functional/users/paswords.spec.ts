...
test.group('Password', (group) => {
  ...
  test('it should return 422 when required data is not provided or data is invalid in forgot password', async ({
    client,
    assert,
  }) => {
  ...
  test('it should return 422 when required data is not provided or data is invalid on password reset', async ({
    client,
    assert,
  }) => {
